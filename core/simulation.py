...
class SpectralCollector(HybridSimulation):
    ...
    def run_collection(self):
        ...
        r_freeze = self.config['spectral']['r_freeze']
        ...
        self.atoms, _ = thermo.initial_relax(self.atoms, self.calculator)
        ...
        for step in range(self.config['simulation']['num_mc_steps']):
            ...
            for n in range(n_solute + 1):
                ...
                if self.run_neb:
                    ...
                    dEf, dEr = thermo.run_neb_calculation(neb_start, final_system, self._init_driver, symbol, step, n_images, r_freeze)
