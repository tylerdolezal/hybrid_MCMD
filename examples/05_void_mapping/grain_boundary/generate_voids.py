...
atoms = read("POSCAR-S5-gb (pure Ni)", format="vasp")

rmin = 1.54 # this gets rid of tetrahedral sites in the bulk
voids_only, full_atoms = find_voids_from_atoms(atoms, S5_bounds, min_radius=rmin)
write("voids-POSCAR-S5", voids_only, format="vasp", direct=True, sort=True)
write("full_voids-POSCAR-S5", full_atoms, format="vasp", direct=True, sort=True)
